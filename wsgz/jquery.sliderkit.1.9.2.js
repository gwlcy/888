...
(function($){
    ...
    SliderKit = function() {
        ...
        this._init = function( element, options ) {
            ...
            //this.cssNames.panel.css( 'display', 'none' );
        ...
        this._buildNav = function() {
            ...
            // Else we start initializing the carousel
                ...
                this.navULSize=this.navLIsize * (this.navLINum-1) + 140;
                //this.navClipSize = (this.options.shownavitems * this.navLIsize) - (this.options.verticalnav ? navLIextVMarg : navLIextHMarg);// Removes the item side margins to center the nav clip
                this.navClipSize = (this.options.shownavitems-1) * this.navLIsize + 140;
        ...
        this._panelTransitions = {
            ...
            fading: function(scrollWay, FirstTime, complete) {
                ...
                $("."+self.cssNames.panelOld, self.domObj).hide();//其他隐藏
